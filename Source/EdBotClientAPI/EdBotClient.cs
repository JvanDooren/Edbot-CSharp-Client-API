namespace EdbotClientAPI
{
    ...
    public class EdbotClient
    {
        ...
        public event EventHandler ListedEdbots;
        ...
        public void SetCustom(string edBotName, string path)
{
        ...
        {
            if (edbotMessage != null && edbotMessage.Auth != null) Auth = edbotMessage.Auth;
        }

        private void UpdateConnectedEdBotNamesList(EdbotServerMessage edbotMessage)
        {
            if (edbotMessage != null && edbotMessage.Edbots != null && edbotMessage.Edbots.Count > 0)
            {
